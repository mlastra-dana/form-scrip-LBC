(function () {
  ...
  function injectBrandActiveStyles() {
    if (document.getElementById("lbc_nps_promotor_active_color_v5")) return;

    var style = document.createElement("style");
    style.id = "lbc_nps_promotor_active_color_v5";

    style.textContent =
      "#form_8567 li.checkboxes.highlighted," +
      "#form_8567 li.checkboxes.selected," +
      "#form_8567 li.checkboxes.focused," +
      "#form_8567 li.checkboxes:focus-within{" +
      "background:#f0f6ff!important;" +
      "background-color:#f0f6ff!important;" +
      "background-image:none!important;" +
      "}" +

      "#form_8567 li.checkboxes.highlighted>div," +
      "#form_8567 li.checkboxes.selected>div," +
      "#form_8567 li.checkboxes.focused>div," +
      "#form_8567 li.checkboxes:focus-within>div{" +
      "background:#f0f6ff!important;" +
      "background-color:#f0f6ff!important;" +
      "background-image:none!important;" +
      "}" +
  ...
  function applyBrandActiveBackground(li) {
    if (!li || isHiddenByPlatform(li)) return;

    var hasChecked = !!li.querySelector("input[type='checkbox']:checked");
    var bg = hasChecked ? "#f0f6ff" : "transparent";
    ...
    Array.from(li.querySelectorAll("input[type='checkbox']")).forEach(function (checkbox) {
      ...
      if (!checkbox.getAttribute("data-lbc-nps-bound")) {
        ...
        checkbox.addEventListener("change", function () {
          updateOptionState();
          setTimeout(updateOptionState, 50);
          setTimeout(updateOptionState, 150);
        });
      }
    });
  }
  ...
  function applyFormStyle() {
    ...
    console.log("LBC NPS promotor v5 aplicado correctamente.");
    return true;
  }
