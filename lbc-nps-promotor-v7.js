(function () {
  ...
  var CONFIG = {
    ...
    eyebrow: "Opciones personalizadas",
    title: "Opciones seleccionadas para ti",
    subtitle: "Puedes explorar alternativas pensadas para seguir protegiéndote. Una aparece recomendada.",
  ...
  function injectStyles() {
    if (document.getElementById("lbc_nps_promotor_v7_styles")) return;

    var style = document.createElement("style");
    style.id = "lbc_nps_promotor_v7_styles";
  ...
  function styleRecommendationCheckboxGroup(li) {
    ...
    var label = li.querySelector("label.description, .description");
    if (label) {
      label.textContent = "Opciones seleccionadas para ti";
      setStyle(label, {
        "display": "none"
      });
    }
  ...
  function applyFormStyle() {
    ...
    console.log("LBC NPS promotor v7 aplicado correctamente.");
    return true;
  }
