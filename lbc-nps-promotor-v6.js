(function () {
  ...
  function injectWhiteFieldStyles() {
    if (document.getElementById("lbc_nps_promotor_white_fields_v6")) return;

    var style = document.createElement("style");
    style.id = "lbc_nps_promotor_white_fields_v6";
  ...
  function styleSelectField(li) {
    ...
    Array.from(li.querySelectorAll("select")).forEach(function (select) {
      ...
      if (!select.getAttribute("data-lbc-select-bound")) {
        select.setAttribute("data-lbc-select-bound", "true");
  ...
  function applyFormStyle() {
    ...
    console.log("LBC NPS promotor v6 aplicado correctamente.");
    return true;
  }
