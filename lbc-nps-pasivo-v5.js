(function () {
  ...
  function injectWhiteSelectionStyles() {
    if (document.getElementById("lbc_nps_pasivo_white_selection_v5")) return;

    var style = document.createElement("style");
    style.id = "lbc_nps_pasivo_white_selection_v5";
  ...
  function applyFormStyle() {
    ...
    console.log("LBC NPS pasivo v5 aplicado correctamente.");
    return true;
  }
