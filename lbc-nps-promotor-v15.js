(function () {
  ...
  var CONFIG = {
    ...
    productInterestFieldLabelTerms: [
  ...
  function injectStyles() {
    if (document.getElementById("lbc_nps_promotor_v15_styles")) return;

    var style = document.createElement("style");
    style.id = "lbc_nps_promotor_v15_styles";

    style.textContent =
      "#form_8567 li,#form_8567 li:hover,#form_8567 li:focus,#form_8567 li:active,#form_8567 li.highlighted,#form_8567 li.selected,#form_8567 li.focused,#form_8567 li:focus-within{" +
      "background:#ffffff!important;background-color:#ffffff!important;background-image:none!important;box-shadow:none!important;" +
      "}" +

      "#form_8567 li>div,#form_8567 li>div:hover,#form_8567 li>div:focus,#form_8567 li>div:active,#form_8567 li:focus-within>div{" +
      "background:#ffffff!important;background-color:#ffffff!important;background-image:none!important;box-shadow:none!important;" +
      "}" +
      ...
      "#form_8567 input[type='text'],#form_8567 input[type='text']:hover,#form_8567 input[type='text']:focus,#form_8567 input[type='email'],#form_8567 input[type='email']:hover,#form_8567 input[type='email']:focus,#form_8567 input[type='tel'],#form_8567 input[type='tel']:hover,#form_8567 input[type='tel']:focus,#form_8567 textarea,#form_8567 textarea:hover,#form_8567 textarea:focus,#form_8567 select,#form_8567 select:hover,#form_8567 select:focus{" +
      "background:#ffffff!important;background-color:#ffffff!important;background-image:none!important;box-shadow:none!important;" +
      "}" +

      "#form_8567 a[href*='previous'],#form_8567 a[href*='back'],#form_8567 a[id*='previous'],#form_8567 a[id*='back'],#form_8567 input[id*='previous'],#form_8567 input[id*='back'],#form_8567 button[id*='previous'],#form_8567 button[id*='back']{" +
  ...
  function findProductInterestField() {
    ...
    for (var i = 0; i < fields.length; i += 1) {
      ...
      for (var j = 0; j < CONFIG.productInterestFieldLabelTerms.length; j += 1) {
        var term = CONFIG.productInterestFieldLabelTerms[j];
  ...
  function bindProductInterestClick() {
    ...
    if (!next.getAttribute("data-lbc-interest-bound")) {
      next.setAttribute("data-lbc-interest-bound", "true");
  ...
  function applyFormStyle() {
    ...
    setTimeout(bindProductInterestClick, 100);
    setTimeout(bindProductInterestClick, 300);
    setTimeout(bindProductInterestClick, 700);

    forceWhiteBackgrounds(form);
    applyMobile();

    console.log("LBC NPS promotor v15 aplicado correctamente.");
    return true;
  }
