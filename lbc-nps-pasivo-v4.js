(function () {
  ...
  var CONFIG = {
    ...
    introCardTitle: "También encontramos opciones para ti.",
    introCardText: "Puedes revisar alternativas simples y cercanas según lo que nos compartiste.",
    feedbackLiId: "li_1",
    optionsLiId: "li_3",
    contactLiId: "li_4",
    phoneLiId: "li_5",
  ...
  function injectWhiteSelectionStyles() {
    if (document.getElementById("lbc_nps_pasivo_white_selection_v4")) return;

    var style = document.createElement("style");
    style.id = "lbc_nps_pasivo_white_selection_v4";
  ...
  function applyFormStyle() {
    ...
    console.log("LBC NPS pasivo v4 aplicado correctamente.");
    return true;
  }
