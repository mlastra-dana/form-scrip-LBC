(function () {
  ...
  function injectStyles() {
    if (document.getElementById("lbc_nps_promotor_v12_styles")) return;

    var style = document.createElement("style");
    style.id = "lbc_nps_promotor_v12_styles";
  ...
  function applyFormStyle() {
    ...
    console.log("LBC NPS promotor v12 aplicado correctamente.");
    return true;
  }
