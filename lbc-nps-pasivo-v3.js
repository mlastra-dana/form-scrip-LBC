(function () {
  ...
  var CONFIG = {
    ...
    introCardTitle: "Estuvimos cerca de una gran experiencia.",
    introCardText: "Selecciona el aspecto que consideras más importante mejorar. Tu opinión nos ayuda a seguir acompañándote mejor.",
    questionLiId: "li_1",
  ...
  function injectWhiteSelectionStyles() {
    if (document.getElementById("lbc_nps_pasivo_white_selection_v3")) return;

    var style = document.createElement("style");
    style.id = "lbc_nps_pasivo_white_selection_v3";
  ...
  function applyFormStyle() {
    ...
    console.log("LBC NPS pasivo v3 aplicado correctamente.");
    return true;
  }
