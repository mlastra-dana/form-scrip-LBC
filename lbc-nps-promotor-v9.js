(function () {
  ...
  var CONFIG = {
    ...
    thanksCardText: "Aquí termina tu feedback. Si deseas conocer alternativas pensadas para ti, puedes continuar a la siguiente experiencia.",
  ...
  function isProductsPage() {
    ...
    var submitFinal = get(CONFIG.submitId);
    return isVisible(recommendationLi) || isVisible(submitFinal);
  }
  ...
  function injectStyles() {
    if (document.getElementById("lbc_nps_promotor_v9_styles")) return;

    var style = document.createElement("style");
    style.id = "lbc_nps_promotor_v9_styles";
  ...
  function styleHeader() {
    ...
    setStyle(get("lbc_nps_header"), {
      ...
      "padding": productsPage ? "24px 22px 18px 22px" : "24px 22px 22px 22px",
  ...
  function applyMobile() {
    ...
    setStyle(get("lbc_nps_header"), {
      ...
      "padding": productsPage ? "20px 18px 18px 18px" : "20px 18px 22px 18px"
    });
  ...
  function applyFormStyle() {
    ...
    console.log("LBC NPS promotor v9 aplicado correctamente.");
    return true;
  }
